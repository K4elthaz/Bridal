<div class="modal fade" role="dialog"  id="create_modal">
    <div class="modal-dialog modal-dialog-top" role="document">
        <div class="modal-content">
            <form method="post" action="/customers/store" class="form" enctype="multipart/form-data">
                @csrf()
                ...
                <div class="modal-body">
                    <div class="row" id="create_body"> 
                        ...
                        <div class="col-md-12">
                            <label class="text-muted">Address <i>(House #/Subdivision/Street)</i></label> <span class="text-danger">&#x2022;</span>
                            <textarea class="form-control" name="address" rows="2" required>{{ old('address') }}</textarea>
                        </div>

                        <div class="col-md-12">
                            <label class="text-muted">Profile Picture (JPG & PNG only) </label> <span class="text-danger">&#x2022;</span>
                            <input type="file" 
                            accept="image/jpeg, image/png, image/jpg"
                            name="profile_picture" multiple class="form-control" required>
                        </div>

                        <div class="col-md-12">
                            <label class="text-muted">ID Picture (JPG & PNG only) </label> <span class="text-danger">&#x2022;</span>
                            <input type="file" 
                            accept="image/jpeg, image/png, image/jpg"
                            name="id_picture" multiple class="form-control" required>
                        </div>
